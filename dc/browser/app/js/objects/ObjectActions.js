...
export class ObjectActions extends React.Component {
  ...
  getObjectInfo(objectname, callback) {
      ...
      <Dropdown id={`obj-actions-${object.name}`}>
        ...
        {this.state.showPreview && (
          <PreviewObjectModal
            ...
            getObjectInfo={this.getObjectInfo.bind(this)}
          />
        )}
      </Dropdown>
    )
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    shareObject: (object, days, hours, minutes) => dispatch(objectsActions.shareObject(object, days, hours, minutes)),
    deleteObject: (object) => dispatch(objectsActions.deleteObject(object)),
    getObjectURL: (object, callback) => dispatch(objectsActions.getObjectURL(object, callback)),
    getObjectInfo: (object, callback) => dispatch(objectsActions.getObjectInfo(object, callback)),
  }
}
